...
import notjs.abstracted.init.InitDOM._
...
object Init {
  ...
  // DOM
  val document_Addr = NewAbstractAddress()
  val document_location_Addr = NewAbstractAddress()
  // XHR
  val XMLHttpRequest_Addr = NewAbstractAddress()
  val XMLHttpRequest_open_Addr = NewAbstractAddress()
  val XMLHttpRequest_addEventListener_Addr = NewAbstractAddress()
  val XMLHttpRequest_abort_Addr = NewAbstractAddress()
  val XMLHttpRequest_getAllResponseHeaders_Addr = NewAbstractAddress()
  val XMLHttpRequest_getResponseHeader_Addr = NewAbstractAddress()
  val XMLHttpRequest_overrideMimeType_Addr = NewAbstractAddress()
  val XMLHttpRequest_setRequestHeader_Addr = NewAbstractAddress()
  val XMLHttpRequest_sendAsBinary_Addr = NewAbstractAddress()
  val XMLHttpRequest_send_Addr = NewAbstractAddress()
  // Event
  val __evt_Addr = NewAbstractAddress()
  val __evt_Obj_initEvent_Addr = NewAbstractAddress()
  val __evt_Obj_doNothing_Addr = NewAbstractAddress()
  ...
  def initState( s:Stmt, τ: Trace ): State = {
    ...
    val initσ = Store(
      ...
      a2o = Map(
             ...
             document_Addr → document_Obj,
             document_location_Addr → document_location_Obj,
             XMLHttpRequest_Addr → XMLHttpRequest_Obj,
             XMLHttpRequest_open_Addr → XMLHttpRequest_open_Obj,
             XMLHttpRequest_abort_Addr → XMLHttpRequest_abort_Obj,
             XMLHttpRequest_getAllResponseHeaders_Addr → XMLHttpRequest_getAllResponseHeaders_Obj,
             XMLHttpRequest_getResponseHeader_Addr → XMLHttpRequest_getResponseHeader_Obj,
             XMLHttpRequest_overrideMimeType_Addr → XMLHttpRequest_overrideMimeType_Obj,
             XMLHttpRequest_setRequestHeader_Addr → XMLHttpRequest_setRequestHeader_Obj,
             XMLHttpRequest_sendAsBinary_Addr → XMLHttpRequest_sendAsBinary_Obj,
             XMLHttpRequest_send_Addr → XMLHttpRequest_send_Obj,
             XMLHttpRequest_addEventListener_Addr → XMLHttpRequest_addEventListener_Obj,
             __evt_Addr → __evt_Obj,
             __evt_Obj_initEvent_Addr → __evt_Obj_initEvent_Obj,
             __evt_Obj_doNothing_Addr → __evt_Obj_doNothing_Obj,
             Dummy_Addr → Dummy_Obj
            ),
      weak = Set(document_Addr)
    )
